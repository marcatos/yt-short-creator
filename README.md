...
- [ ] (Optional) On **Replays**, create an iRacing session and click **Auto-record replay** (iRacing must allow video capture), or attach an MP4 manually, then Analyze / approve a `REPLAY` candidate.
